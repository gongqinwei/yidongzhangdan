...
#define GOOGLE_MAP_API          @"http://maps.google.com/maps/api/geocode/json?sensor=false&address=%@"
#define GOOGLE_DIRECTION_API    @"http://maps.google.com/?saddr=Current+Location&daddr=%f,%f"
#define GOOGLE_MAP_LAT          @"\"lat\" :"
#define GOOGLE_MAP_LON          @"\"lng\" :"
