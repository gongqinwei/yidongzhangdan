//
//  ApprovalCommentViewController.h
//  Mobill
//
...
@interface ApprovalCommentViewController : UIViewController

@property (weak, nonatomic) IBOutlet UINavigationItem *approvalCommentNavigationItem;
